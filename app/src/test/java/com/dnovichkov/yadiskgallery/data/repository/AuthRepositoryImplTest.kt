...
class AuthRepositoryImplTest {
    ...
    @Test
    fun `initial auth state is NotAuthenticated`() = runTest {
    ...
    @Test
    fun `authenticate sets state to Authenticating`() = runTest {
    ...
    @Test
    fun `onAuthenticationSuccess updates state and stores tokens`() = runTest {
    ...
    @Test
    fun `logout clears tokens and sets state to NotAuthenticated`() = runTest {
        // First authenticate
    ...
    @Test
    fun `getAccessToken delegates to token storage`() = runTest {
    ...
    @Test
    fun `getAccessToken returns null when no token`() = runTest {
    ...
    @Test
    fun `isTokenValid returns false when token expired`() = runTest {
        coEvery { tokenStorage.getAccessToken() } returns "test_token"
    ...
    @Test
    fun `isTokenValid returns false when no token`() = runTest {
        coEvery { tokenStorage.getAccessToken() } returns null
    ...
    @Test
    fun `setPublicAccess updates state and stores url`() = runTest {
    ...
    @Test
    fun `onAuthenticationError sets state to AuthError`() = runTest {
    ...
    @Test
    fun `getAuthState returns PublicAccess when public url is set`() = runTest {
