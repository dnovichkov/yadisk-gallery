...
class GetAuthStateUseCaseTest {
    ...
    inner class InvokeTests {
        ...
        fun `should return NotAuthenticated state`() = runTest {
        ...
        fun `should return Authenticated state`() = runTest {
        ...
        fun `should return PublicAccess state`() = runTest {
    ...
    inner class IsAuthenticatedTests {
        ...
        fun `should return false for public access`() = runTest {
