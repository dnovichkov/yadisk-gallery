...
class GetCacheSizeUseCaseTest {
    ...
    inner class InvokeTests {
        ...
        fun `should return cache size in bytes`() =
            runTest {
        ...
        fun `should return zero for empty cache`() =
            runTest {
    ...
    inner class ObserveCacheSizeTests {
        ...
        fun `should observe cache size changes`() =
            runTest {
    ...
    inner class GetMaxCacheSizeTests {
        ...
        fun `should return max cache size`() =
            runTest {
