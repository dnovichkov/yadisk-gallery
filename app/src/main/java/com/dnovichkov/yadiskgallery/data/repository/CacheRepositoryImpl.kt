...
class CacheRepositoryImpl
    ...
    constructor(
        ...
        override suspend fun isCached(path: String): Boolean =
            withContext(Dispatchers.IO) {
        ...
        override suspend fun getCachedPath(path: String): String? =
            withContext(Dispatchers.IO) {
                val cacheFile = getCacheFileForPath(path)
                if (cacheFile.exists()) {
                    hitCount++
        ...
        override suspend fun cacheFile(path: String): Result<Unit> =
            withContext(Dispatchers.IO) {
                runCatching {
