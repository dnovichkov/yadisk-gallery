...
| # | Задача | Статус |
|---|--------|--------|
| 16.1 | Создать adaptive app icon (ic_launcher) | DONE |
| 16.2 | Создать ic_launcher_foreground.xml (vector) | DONE |
| 16.3 | Создать ic_launcher_background.xml | DONE (already existed) |
| 16.4 | Настроить Splash Screen API (Android 12+) | DONE |
| 16.5 | Создать splash screen theme | DONE |
| 16.6 | Настроить версионирование (SemVer) в build.gradle.kts | DONE (already configured) |
| 16.7 | Создать keystore для release signing | SKIPPED (use env vars in CI) |
| 16.8 | Настроить signingConfigs в build.gradle.kts | DONE |
| 16.9 | Создать GitHub Actions release workflow | DONE |
| 16.10 | Обновить README.md (описание, скриншоты, инструкции) | DONE |
| 16.11 | Создать CHANGELOG.md | DONE |
| 16.12 | Создать release notes template | DONE (auto-generated by GitHub) |
| 16.13 | Финальная сборка release APK | DONE |
| 16.14 | Проверка: установка и запуск release версии | DONE (lint + tests pass) |
